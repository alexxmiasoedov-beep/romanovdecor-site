...
#    люков — работа €45/м² плоскости (как дверное полотно) + €5/м.п.
#    торца, материал по ставке стен отдельной строкой;
...
FURN_M2, FURN_EDGE = 45.0, 5.0      # фасады: €/м² плоскости (как полотно), €/м.п. торца
...
FURN_AREA = 1.106       # МДФ-фасады люков инсталляции, 2×388×1425
FURN_MP = 7.25          # торцы фасадов, весь периметр обеих дверц
...
<b style="color:#2c2c2c">Инсталляция и фасады:</b> гипсовый короб инсталляции отделывается микроцементом как стена; МДФ-фасады люков — материал по ставке стен, работа {u(FURN_M2)}/м² плоскости (как полотно) + {u(FURN_EDGE)}/м.п. торца по периметру.<br>
