...
DELAYS_MIN = (0.5, 1, 5, 30)                # задержки копирования, мин; первая — рабочая (бот ≈ 30 с)
...
MIN_DELAYED_ROI_KEEP = 0.60                 # ROI с рабочей задержкой ≥ 60 % сырого
COPY_DELAY_SEC = 30                         # задержка бота от его сделки до нашего ордера
SIM_EXTRA_SLIPPAGE_REL = 0.0                # сверх аска/бида: ордер $1 глубину не выбирает
TAPE_PAGES = 8                              # страниц ленты сделок рынка (по 500) для поиска цены через 30 с
